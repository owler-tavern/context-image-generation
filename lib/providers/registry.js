...
export const PROVIDERS = {
    ...
    zai: {
        ...
        ui: {
            ...
            modelDiscovery: false,
            adapterRequired: true,
            providerInfo: 'Experimental: native Z.AI image generation uses the curated CogView/GLM payload. Reference images and editing remain disabled until model evidence proves support.',
        },
    ...
    arliai: {
        ...
        ui: {
            ...
            modelDiscovery: false,
            adapterRequired: true,
            providerInfo: 'Experimental: ArliAI uses the source-verified SD-style text-to-image request. References and editing remain disabled.',
        },
