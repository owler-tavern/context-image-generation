...
export function validateProviderRoute({ providerId, modelId, transportId } = {}) {
    const provider = getProviderDefinition(providerId);
    ...
    const declaredTransport = model.transport || model.transportId;
    ...
    return { provider, model, adapterId: expectedAdapter };
}
