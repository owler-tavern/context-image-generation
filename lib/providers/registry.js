...
const GEMINI_MODELS = [
    { id: 'gemini-2.5-flash-image', label: 'Nano Banana 🍌 (~$0.04/img)', variant: 'flash', referenceImages: { maxCount: 3 }, status: 'existing' },
    { id: 'gemini-3.1-flash-image-preview', label: 'Nano Banana 2 🍌 (Flash)', variant: 'flash2', imageSizeOptions: FLASH_2_IMAGE_SIZES, referenceImages: { maxCount: 4 }, supportsThinking: true, supportsGoogleSearch: true, status: 'existing' },
    { id: 'gemini-3-pro-image-preview', label: 'Nano Banana Pro 🍌 (~$0.14/img)', variant: 'pro', imageSizeOptions: PRO_IMAGE_SIZES, referenceImages: { maxCount: 14 }, status: 'existing' },
];
