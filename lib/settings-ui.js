...
export function projectReferencePreferences(_savedPreferences, supportsReferenceImages) {
    const supported = supportsReferenceImages === true;
    return {
        showAvatarControl: supported,
        showPreviousImageControl: supported,
        note: supported ? '' : 'Visual references are unavailable for this model. Your saved reference preferences will be used when available.',
    };
}
