...
export function createStoryMemoryController(dependencies = {}) {
    ...
    async function load({ chatId, gallery = [] } = {}) {
        ...
        state = { ...state, chatId: targetChatId, epoch: targetEpoch, status: 'loading', error: null, message: 'Loading story memory…', filters: { ...state.filters, ...(targetChatId ? { chatId: targetChatId } : {}) } };
