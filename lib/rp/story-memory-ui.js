...
function projectedTimeline(memory, filters) {
    ...
    return Object.keys(normalized).length ? searchStoryArtifacts(memory, normalized) : getStoryTimeline(memory, normalized.chatId === undefined ? {} : { chatId: normalized.chatId });
}
