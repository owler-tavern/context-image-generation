...
/** Writes one chat-canon candidate through the host's coordinated save seam. */
export async function persistChatCanonMetadata({ metadata, candidate, save } = {}) {
    ...
    if (typeof save !== 'function') throw new TypeError('A coordinated chat save callback is required.');
