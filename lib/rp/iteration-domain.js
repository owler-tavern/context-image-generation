...
export function sanitizeIterationArtifactForStorage(value = {}) {
    ...
    return {
        ...
        recipeAvailable: Boolean(bounded(recipe.effectivePrompt, 4000) && (recipe.route?.providerId || recipe.model?.providerId) && (recipe.route?.modelId || recipe.model?.modelId)),
        sourcePassage: {
...
function artifactInput(value = {}) {
    ...
    return {
        recipeAvailable: value.recipeAvailable !== false && recipe.recipeAvailable !== false,
