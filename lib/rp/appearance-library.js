...
export function applyGalleryImageDeletion({ gallery = [], index, protectedIds = new Set(), confirmed } = {}) {
    ...
    return { decision: 'deleted', gallery: items.filter((_entry, entryIndex) => entryIndex !== index) };
}
