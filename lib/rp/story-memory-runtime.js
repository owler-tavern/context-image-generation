...
function compactArtifact(value) {
    ...
    const sourceMoment = isRecord(source.sourceMoment) ? source.sourceMoment : {};
    ...
    return {
        ...
        messageId: Number.isFinite(Number(source.messageId)) ? Number(source.messageId) : null,
        ...
        ...(Number.isFinite(Number(source.sequence)) ? { sequence: Number(source.sequence) } : {}),
        ...(Number.isFinite(Number(source.order)) ? { order: Number(source.order) } : {}),
        ...
        sourceMoment: {
            ...
            messageId: Number.isFinite(Number(sourceMoment.messageId)) ? Number(sourceMoment.messageId) : null,
        },
        generation: {
        ...
        provenance: {
            ...
            ...(provenance.messageId !== undefined ? { messageId: Number(provenance.messageId) } : {}),
            ...(provenance.mediaId ? { mediaId: bounded(provenance.mediaId, 180) } : {}),
            ...(provenance.version !== undefined ? { version: Number(provenance.version) || 1 } : {}),
