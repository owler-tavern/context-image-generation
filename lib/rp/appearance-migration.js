...
export async function runClearGalleryPreservingLooks({ gallery = [], io, withinExclusive = false } = {}) {
    ...
    cleared.library.revision = `appearance-gallery-cleared:${io.uuid()}`;
    let verification;
    ...
    return { status: 'confirmed', ...cleared, migrations, message: 'Gallery cleared. Remembered appearances are still available.' };
}
