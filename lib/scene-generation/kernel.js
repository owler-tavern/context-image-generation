...
/**
 * Create the dormant shared generation transaction.
 *
 ...
 * - dispatch: the provider-dispatch portion of generateImageFromPromptInternal
 * - coordinate: generationCoordinator.run
 *
