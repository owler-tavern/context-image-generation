...
export function removeRetiredGenerationDeadline(settings) {
    if (!isRecord(settings) || !Object.hasOwn(settings, 'generation_deadline_ms')) return false;
    delete settings.generation_deadline_ms;
    return true;
}
