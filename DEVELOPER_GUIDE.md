...
| Z.AI and other provider-native/async inventory entries | No browser transport | Server adapter only | **Unavailable.** Their native payloads, binary/async lifecycles, secret handling, or SSRF/output policies do not fit the validated browser adapter. |
